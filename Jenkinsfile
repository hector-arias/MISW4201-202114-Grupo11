pipeline { 
    ...
    environment {
        ...
        GIT_REPO = 'MISW4201-202114-Grupo11'
    }
    stages {
        stage('Checkout') { 
            steps {
        ...
        stage('Gitinspector') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: env.GIT_CREDENTIAL_ID, passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                    ...
                    sh('git pull https://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@github.com/MISW-4102-ProcesosDeDesarrolloAgil/${GIT_REPO} main')
                    sh('git push https://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@github.com/MISW-4102-ProcesosDeDesarrolloAgil/${GIT_REPO} main')
                }  
            }
        }
